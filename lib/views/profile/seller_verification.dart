...
class SellerVerificationForm extends StatelessWidget {
      ...
      body: Form(
        ...
        child: ListView(
          ...
          children: [
            ...
            Text(
              'Businesses of tomorrow are built on trust, and genuine community. Please enter the code sent to +2557••••517.',
              style: TextStyle(
