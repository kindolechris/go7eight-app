...
import 'package:prime_social_media_flutter_ui_kit/controller/profile/settings_options/like_option_controller.dart';
...
class LikeView extends StatelessWidget {
  ...
  LikeOptionController likeOptionController = Get.put(LikeOptionController());
        ...
        children: [
          Row(
            ...
            children: [
              ...
              GestureDetector(
                onTap: () {
                  likeOptionController.toggleLike();
                },
                child: Obx(() => Image.asset(
                  likeOptionController.isSwitchLike.value ? AppIcon.switchOn : AppIcon.switchOff,
