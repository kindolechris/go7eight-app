...
import 'package:prime_social_media_flutter_ui_kit/controller/profile/settings_options/repost_option_controller.dart';
...
class RepostOptionView extends StatelessWidget {
  RepostOptionView({Key? key}) : super(key: key);

  RepostOptionController repostOptionController = Get.put(RepostOptionController());
        ...
        children: [
          Row(
            ...
            children: [
              ...
              GestureDetector(
                onTap: () {
                  repostOptionController.toggleRepost();
                },
                child: Obx(() => Image.asset(
                  repostOptionController.isSwitchRepost.value ? AppIcon.switchOn : AppIcon.switchOff,
