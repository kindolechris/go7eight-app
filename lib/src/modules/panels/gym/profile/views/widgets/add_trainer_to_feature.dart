...
import 'gym_trainer_list_view.dart';

class AdTrainerToFeatureBottomSheet extends GetView<GYMProfileController> {
  const AdTrainerToFeatureBottomSheet({super.key});
              ...
              children: [
                ...
                Expanded(
                  child: AppButton(
                    action: () {
                      Navigator.pop(context);
                      Get.to(() => const GYMTrainerListView(),
