...
class SessionRatingView extends GetView<GYMSessionController> {
  final String title;

  const SessionRatingView({super.key, required this.title});
  @override
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: sessionAppBar(context, showSaveIcon: false, title: title.tr),
            ...
            Container(
              ...
              child: ListView.builder(
                  ...
                  itemBuilder: (context, index) {
                    return RatingContainerWidget(ratingIndex: index);
                  }),
            ),
          ],
        ),
