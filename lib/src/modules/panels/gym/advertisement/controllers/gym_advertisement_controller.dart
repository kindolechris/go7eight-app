...
import '../../../../../data/dummy_dataset/ad_dummy_data.dart';
import '../../../../../data/dummy_dataset/challenge_image_data.dart';
import '../../../../../data/dummy_dataset/session_image_data.dart';
import '../../../../../data/dummy_dataset/session_tags.dart';
import '../../../../../data/dummy_dataset/session_title_data.dart';
import '../../../../../data/dummy_dataset/session_video_data.dart';
import '../../../../../data/dummy_dataset/trainer_image_data.dart';
import '../../../../../data/dummy_dataset/trainer_name_data.dart';
import '../../../../../data/dummy_dataset/user_image_data.dart';
import '../../../../../models/advertisement_model.dart';
import '../../../../../models/challenge_model.dart';
import '../../../../../models/image_size_model.dart';
import '../../../../../models/session_model.dart';
import '../../../../../models/user_model.dart';
import '../views/add_ad_view.dart';
class GYMAdvertisementController extends GetxController {
  ...
  gotoAdAdvertisement() {
    Get.to(() => const GYMAddAdvertisementView(),
  ...
  String getItemListName(int index) {
    if (selectedTypeOfAdvertisement.value == typeOfAdvertisementList[1]) {
      return trainerList[index].name!;
    } else if (selectedTypeOfAdvertisement.value == typeOfAdvertisementList[2]) {
