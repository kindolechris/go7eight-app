...
class BasicTrainingInfo extends StatelessWidget {
      ...
      child: AppContainerWidget(
        ...
        children: [
          _basicInfoItem(context,
              itemKey: "sessions_title".tr, itemValue: sessionCount),
          Container(
            height: 40,
            width: 1,
          ...
          _basicInfoItem(context,
              itemKey: "challenges_title".tr, itemValue: challengeCount),
          Container(
            height: 40,
            width: 1,
            color: Theme.of(context).brightness == Brightness.light
          ...
          _basicInfoItem(context,
              itemKey: "followers_title".tr, itemValue: followerCount),
        ],
      )),
    );
  }
  ...
  Widget _basicInfoItem(BuildContext context,
    ...
    return Expanded(
        child: Column(
      children: [
        Text(itemValue, style: TextStyleX.subHeading3(context)),
        Text(itemKey, style: TextStyleX.subHeading2BlueGrey(context)),
      ],
    ));
  }
}
