...
class MyFavoriteView extends GetView<ProfileController> {
      ...
      body: Container(
          ...
          child: ListView(
            ...
            children: [
              ...
              Obx(() {
                return _myFavoriteCarouselSection(
  ...
  Widget _myFavoriteCarouselSection({required SessionType sessionType}) {
