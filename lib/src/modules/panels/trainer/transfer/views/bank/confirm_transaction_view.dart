...
class ConfirmTransactionView extends GetView<TrainerTransferController> {
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      Container(
                        ...
                        decoration: BoxDecoration(
                          ...
                          image: const DecorationImage(
                              image: AssetImage(AppIcon.bank2Icon),
                              fit: BoxFit.contain),
                        ),
                      ),
                      ...
                      _detailItemWidget(context,
                          itemKey: "account_name_lbl", itemValue: "Mr Baker"),
                      _detailItemWidget(context,
                          itemKey: "bank_name_lbl",
                          itemValue: "Bank of America"),
                      _detailItemWidget(context,
                          itemKey: "account_no_lbl", itemValue: "654987987541"),
                      _detailItemWidget(context,
                          itemKey: "amount_lbl",
                          itemValue:
              ...
              showModalBottomSheet(
                ...
                builder: (context) {
                  return Padding(
                    ...
                    child: const PinCodeBottomSheet(isBankPayment: true),
                  );
                },
              );
            },
