...
class RecipeAddIngredientBottomsheet extends GetView<TrainerAddRecipeController>{
  const RecipeAddIngredientBottomsheet({super.key});
                      ...
                      return Container(
                        ...
                        child: DropdownButton<String>(
                          ...
                          dropdownColor: Theme
                              ...
                              ? AppColor.white
                              : AppColor.blackShade,
                          value: "${controller.ingredientUnitValue}",
                          items: <String>[
                            'Ounce',
                            'Piece',
                            'ML',
                          ...
                          onChanged: (value) {
                            ...
                            controller.ingredientUnitValue.value = value!;
                          },
                        ),
                      );
                    })
      ...
      child: Row(
        ...
        children: [
          ...
          Expanded(
              ...
              AppButton(
                action: () {
                  controller.addIngredient(isSpice: false);
                  Navigator.pop(context);
