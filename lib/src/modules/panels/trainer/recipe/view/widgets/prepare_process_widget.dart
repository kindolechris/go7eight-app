...
class PrepareProcessWidget extends GetView<TrainerAddRecipeController> {
  const PrepareProcessWidget({super.key});
              ...
              builder: (context) {
                return Container(
                    ...
                    child: const RecipeAddProcessBottomsheet(
                      mealProcessType: MealProcessType.prepare,
                    ));
              },
            );
          },
          child: Obx(() {
            return controller.prepareList.isNotEmpty
                ? ListView.builder(
                    shrinkWrap: true,
                    padding: EdgeInsets.zero,
                    physics: const NeverScrollableScrollPhysics(),
                    itemCount: controller.prepareList.length,
