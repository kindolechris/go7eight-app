...
class CookProcessWidget extends GetView<TrainerAddRecipeController> {
  const CookProcessWidget({super.key});
              ...
              builder: (context) {
                return Container(
                    ...
                    child: const RecipeAddProcessBottomsheet(
                      mealProcessType: MealProcessType.cook,
                    ));
              },
            );
          },
          child: Obx(() {
            return controller.cookList.isNotEmpty
                ? ListView.builder(
                    shrinkWrap: true,
