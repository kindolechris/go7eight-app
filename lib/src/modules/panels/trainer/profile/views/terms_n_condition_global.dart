...
class GlobalTermsNConditionView extends GetView<TrainerProfileController> {
  const GlobalTermsNConditionView({super.key});
      ...
      child: Scaffold(
        ...
        body: Container(
            ...
            child: ListView(
              ...
              children: [
                Container(
                  child: _termsAndConditionData(context),
                )
              ],
            )
  ...
  _termsAndConditionData(BuildContext context) {
    return Container(
      margin: EdgeInsets.symmetric(
        horizontal: AppRatioSize.getRatioWidth() / 24,
      ),
      child: AppHtmlView.applyHtml(context,
          text: """<h3>What is Lorem Ipsum?</h3>
