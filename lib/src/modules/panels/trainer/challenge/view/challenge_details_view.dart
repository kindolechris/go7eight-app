...
class TrainerChallengeDetailsView
    extends GetView<TrainerChallengeListController> {
  final String title;
  final bool isReadyToPublish;
  final SessionType sessionType;
  final ChallengeModel challenge;

  const TrainerChallengeDetailsView(
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      bottomNavigationBar:
          BottomChallengeNavWidget(isReadyToPublish: isReadyToPublish),
    );
  }
