...
class ChallengeRatingContainer extends GetView<TrainerChallengeListController> {
  const ChallengeRatingContainer({super.key});
  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      child: Row(
        ...
        children: [
          _ratingValueContainer(context),
          _seeRatingTextButton(context)
        ],
      ),
    );
  }

  Widget _ratingValueContainer(BuildContext context) {
    return Row(
      children: [
        SizedBox(
  ...
  Widget _seeRatingTextButton(BuildContext context) {
    return GestureDetector(
      onTap: controller.gotoChallengeRatingView,
      child: Row(
        children: [
          Text(
            "see_rating_lbl".tr,
