...
class ChallengeAdminReasonBottomSheet extends StatefulWidget {
  final String actionType;
  final int index;

  const ChallengeAdminReasonBottomSheet({
    super.key,
    required this.actionType,
    required this.index,
  });
  @override
  State<ChallengeAdminReasonBottomSheet> createState() =>
      _ChallengeAdminReasonBottomSheetSheetState();
}

class _ChallengeAdminReasonBottomSheetSheetState
    extends State<ChallengeAdminReasonBottomSheet> {
  TrainerChallengeListController controller = Get.find();
  @override
        ...
        children: [
          ...
          Container(
            ...
            child: Text(
              ...
              "\nI would like to tell you that this challenge has few sessions that are against our rule and need improvement."
