...
class ChallengeAddOverviewBottomsheet extends GetView<TrainerAddChallengeController>{
  const ChallengeAddOverviewBottomsheet({super.key});
                   ...
                   child: QuillHtmlEditor(
                       ...
                       textStyle: Theme
                         ...
                         Theme
                             .of(context)
                             .brightness == Brightness.light
                             ? AppColor.textBlueGrey : AppColor.creamColor,
