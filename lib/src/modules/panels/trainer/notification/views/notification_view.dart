...
class TrainerNotificationView extends GetView<TrainerNotificationController> {
  const TrainerNotificationView({super.key});
                            ...
                            Row(
                              children: [
                                ...
                                Expanded(
                                  ...
                                  children: [
                                    Text(
                                      "You request to feature the session named 'High-Intensity Interval Training' has been accepted by the admin "
                                          .tr,
                                      textAlign: TextAlign.justify,
                                      style:
                                          TextStyleX.body3(context).copyWith(
                                        fontSize:
                                            AppTextSizes.headerText3() / 1.1,
                                      ),
                                      maxLines: 3,
                                    ),
                                    Text(
                                      "${index * 2 + 1} hours ago".tr,
