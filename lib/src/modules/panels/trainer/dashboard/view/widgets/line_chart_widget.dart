...
import 'package:go7eight/src/modules/panels/trainer/dashboard/controllers/trainer_dashboard_controller.dart';
...
class _LineChartGYMState extends State<LineChartGYM> {
  final TrainerDashboardController _controller = Get.find();
