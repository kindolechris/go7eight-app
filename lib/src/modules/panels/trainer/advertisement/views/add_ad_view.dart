...
class TrainerAddAdvertisementView
    extends GetView<TrainerAdvertisementController> {
  const TrainerAddAdvertisementView({super.key});
                            ...
                            children: [
                              SizedBox(
                                ...
                                child: ClipRRect(
                                  borderRadius: BorderRadius.circular(12),
                                  child: Image.file(
                                    File(controller.selectedAdImagePath.value),
                                    fit: BoxFit.cover,
                                  ),
                                ),
                              ),
                    ...
                    ? Column(
                        children: [
                          ...
                          Container(
                            ...
                            margin: EdgeInsets.symmetric(
                                horizontal: AppRatioSize.getRatioWidth() / 25),
                            decoration: BoxDecoration(
                ...
                return (controller.selectedTypeOfAdvertisement.value ==
                    ...
                    : GestureDetector(
                        ...
                        child: Container(
                          ...
                          alignment: Alignment.center,
                          child: Text(
                              "${"select_for_ad_lbl".tr}: ${controller.selectedTypeOfAdvertisement.value.tr}",
                              style: TextStyleX.subHeading2BlueGrey(context)),
                        ),
                      );
              }),
