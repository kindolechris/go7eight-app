...
import '../trainer_ad_item_list_view.dart';

class AdItemFilterBottomSheet extends GetView<TrainerAdvertisementController> {
        ...
        children: [
          Container(
            ...
            child: Container(
              ...
              child: Text(
                "filter_lbl".tr +
                    " ${controller.selectedTypeOfAdvertisement.value}".tr,
          ...
          controller.selectedTypeOfAdvertisement.value ==
                      controller.typeOfAdvertisementList[2] ||
                  controller.selectedTypeOfAdvertisement.value ==
                  ...
                  child: AppButton(
                    action: () {
                      ...
                      controller.adItemListGet(
                          controller.selectedTypeOfAdvertisement.value);
                      Get.to(() => const TrainerAdItemListView(),
